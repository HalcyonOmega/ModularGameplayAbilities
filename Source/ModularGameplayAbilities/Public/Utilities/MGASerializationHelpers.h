...
#include "MGASerializationHelpers.generated.h"

class UAbilitySystemComponent;

USTRUCT(BlueprintType)
struct FMGAActorSaveData
{
	GENERATED_BODY()
...
UCLASS()
class UMGASaveGame : public USaveGame
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class MODULARGAMEPLAYABILITIES_API UMGASerializationHelpers : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
