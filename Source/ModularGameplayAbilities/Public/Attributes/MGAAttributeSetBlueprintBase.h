...
#include "MGAAttributeSetBlueprintBase.generated.h"
...
class MODULARGAMEPLAYABILITIES_API UMGAAttributeSetBlueprintBase : public UAttributeSet
{
	GENERATED_BODY()
	REPLICATED_BASE_CLASS(UMGAAttributeSetBlueprintBase)

public:
	explicit UMGAAttributeSetBlueprintBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
