 ...
 */
class FMGABlueprintEditor : public FBlueprintEditor
{
public:
	FMGABlueprintEditor();
	virtual ~FMGABlueprintEditor() override;
...
private:
	...
	void HandleAttributeWindowFinish(const TSharedPtr<FMGANewAttributeViewModel>& InViewModel);
