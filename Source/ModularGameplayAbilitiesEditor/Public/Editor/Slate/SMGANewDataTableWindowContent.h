...
class FNewDataTableWindowViewModel : public IMGASlateViewModel
{
 ...
 */
class SMGANewDataTableWindowContent : public SCompoundWidget
{
	friend class SMGADataTableListViewRow;

public:
	SLATE_BEGIN_ARGS(SMGANewDataTableWindowContent)
		{
		}
