...
#include "IMGAGameplayAttributeDataDetailsBase.h"
 ...
 */
class FMGAGameplayAttributeDataDetails : public IMGAGameplayAttributeDataDetailsBase
{
public:
	FMGAGameplayAttributeDataDetails();
	virtual ~FMGAGameplayAttributeDataDetails() override;
