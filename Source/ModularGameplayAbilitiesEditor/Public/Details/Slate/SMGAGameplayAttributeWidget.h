...
/**
 * Forked version of SGameplayAttributeWidget to allow display of ClassGeneratedBy classes (Blueprint) and support for
 * ShowOnlyOwnedAttributes UPROPERTY metadata to determine whether attribute properties of super class should be listed.
 */
class SMGAGameplayAttributeWidget : public SCompoundWidget
{
public:
	...
	SLATE_BEGIN_ARGS(SMGAGameplayAttributeWidget)
