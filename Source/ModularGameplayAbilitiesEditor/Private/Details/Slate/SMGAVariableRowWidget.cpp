...
// void SMGAVariableRowWidget::Construct(const FArguments& InArgs, const TSharedPtr<SWidget>& InNameContent, const TSharedPtr<SWidget>& InValueContent)
void SMGAVariableRowWidget::Construct(const FArguments& InArgs)
{
