 ...
 */
class SMGANewAttributeVariableWidget : public SCompoundWidget
{
public:

	DECLARE_DELEGATE_OneParam(FOnWindowClosed, const TSharedPtr<FMGANewAttributeViewModel>&);
	
	SLATE_BEGIN_ARGS(SMGANewAttributeVariableWidget) {}
	...
	void Construct(const FArguments& InArgs, const TSharedPtr<FMGANewAttributeViewModel>& InViewModel);
...
private:
	...
	TSharedPtr<FMGANewAttributeViewModel> ViewModel;
