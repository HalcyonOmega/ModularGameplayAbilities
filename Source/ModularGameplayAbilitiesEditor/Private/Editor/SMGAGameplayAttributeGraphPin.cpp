...
#include "Editor/SMGAGameplayAttributeGraphPin.h"
...
void SMGAGameplayAttributeGraphPin::Construct( const FArguments& InArgs, UEdGraphPin* InGraphPinObj )
{
...
TSharedRef<SWidget>	SMGAGameplayAttributeGraphPin::GetDefaultValueWidget()
{
	...
	return SNew(SVerticalBox)
		...
		.AutoHeight()
		[
			SNew(SMGAGameplayAttributeWidget)
			.OnAttributeChanged(this, &SMGAGameplayAttributeGraphPin::OnAttributeChanged)
			.DefaultProperty(DefaultAttribute.GetUProperty())
			.Visibility(this, &SGraphPin::GetDefaultValueVisibility)
			.IsEnabled(this, &SMGAGameplayAttributeGraphPin::GetDefaultValueIsEnabled)

		];
}

void SMGAGameplayAttributeGraphPin::OnAttributeChanged(FProperty* SelectedAttribute)
{
	FString FinalValue;
