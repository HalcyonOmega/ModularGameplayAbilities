...
class SMGANewDataTableWindowContent;
 ...
 */
class SMGADataTableListViewRow : public SMultiColumnTableRow<FDataTableEditorRowListViewDataPtr>
{
public:
	SLATE_BEGIN_ARGS(SMGADataTableListViewRow)
			: _IsEditable(false)
		{
		}

		/** The owning object. This allows us access to the actual data table being edited as well as some other API functions. */
		SLATE_ARGUMENT(TSharedPtr<SMGANewDataTableWindowContent>, HostWidget)
...
private:
	...
	TWeakPtr<SMGANewDataTableWindowContent> HostWidget;
