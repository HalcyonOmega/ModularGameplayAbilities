...
#define LOCTEXT_NAMESPACE "MGAScaffoldUtils"

GameProjectUtils::EAddCodeToProjectResult FMGAScaffoldUtils::AddClassToProject(
...
GameProjectUtils::EAddCodeToProjectResult FMGAScaffoldUtils::AddCodeFileToProject(const FString& InDestination, const FString& InContent, FText& OutErrorText)
{
	// Generate
...
bool FMGAScaffoldUtils::UpdateProjectFiles(FText& ErrorText)
{
	TArray<FString> CreatedFiles;
...
bool FMGAScaffoldUtils::GenerateBasicSourceCode(const FString& NewProjectSourcePath, const FString& NewProjectName, TArray<FString>& OutGeneratedStartupModuleNames, TArray<FString>& OutCreatedFiles, FText& OutFailReason)
{
...
bool FMGAScaffoldUtils::GenerateGameModuleTargetFile(const FString& NewTargetFileName, const FString& ModuleName, const TArray<FString>& ExtraModuleNames, FText& OutFailReason)
{
	FString Template;
...
bool FMGAScaffoldUtils::GenerateEditorModuleBuildFile(const FString& InNewBuildFileName, const FString& InModuleName, const TArray<FString>& OutPublicDependencyModuleNames, const TArray<FString>& OutPrivateDependencyModuleNames, FText& OutFailReason)
{
	FString Template;
...
bool FMGAScaffoldUtils::GenerateEditorModuleTargetFile(const FString& NewTargetFileName, const FString& ModuleName, const TArray<FString>& ExtraModuleNames, FText& OutFailReason)
{
	FString Template;
	if (!GameProjectUtils::ReadTemplateFile(TEXT("Stub.Target.cs.template"), Template, OutFailReason))
	{
...
bool FMGAScaffoldUtils::GenerateGameModuleCPPFile(const FString& NewGameModuleCPPFileName, const FString& ModuleName, const FString& GameName, FText& OutFailReason)
{
	FString Template;
...
bool FMGAScaffoldUtils::GenerateGameModuleHeaderFile(const FString& NewGameModuleHeaderFileName, const TArray<FString>& PublicHeaderIncludes, FText& OutFailReason)
{
	FString Template;
...
FString FMGAScaffoldUtils::MakeCopyrightLine()
{
...
FString FMGAScaffoldUtils::GetModuleBuildCSFilename(const FModuleContextInfo& InModuleContextInfo)
{
	return FString::Printf(TEXT("%s.Build.cs"), *InModuleContextInfo.ModuleName);
}

FString FMGAScaffoldUtils::GetModuleBuildCSFilePath(const FModuleContextInfo& InModuleContextInfo)
{
	return InModuleContextInfo.ModuleSourcePath / GetModuleBuildCSFilename(InModuleContextInfo);
}

bool FMGAScaffoldUtils::DoesBuildCSFileContains(const FModuleContextInfo& InModuleContextInfo, const FString& InSearchPattern, FText& OutFailReason)
{
...
bool FMGAScaffoldUtils::DoesBuildCSSatisfiesDependencies(const FModuleContextInfo& InModuleContextInfo, const TArray<FString>& InModuleDependencies, TArray<FString>& OutMissingModuleDependencies, FText& OutFailReason)
{
...
FString FMGAScaffoldUtils::GetContainingModuleName(const UStruct* InStruct)
{
	check(InStruct);
