 ...
 * -> SMGAHeaderView
 */
class SMGAAttributeSetWizard : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SMGAAttributeSetWizard) {}

	SLATE_END_ARGS()

	/** Constructs this widget with InArgs */
	void Construct(const FArguments& InArgs, const FAssetData& InAssetData);
	virtual ~SMGAAttributeSetWizard() override;
...
protected:
	...
	/** Header View widget */
	TSharedPtr<SMGAHeaderView> HeaderViewWidget;
