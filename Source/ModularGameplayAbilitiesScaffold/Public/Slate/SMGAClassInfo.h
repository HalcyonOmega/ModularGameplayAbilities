 ...
 */
class SMGAClassInfo : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SMGAClassInfo) {}
	SLATE_END_ARGS()

	/** Constructs this widget with InArgs */
	void Construct(const FArguments& InArgs, const TSharedPtr<FMGAAttributeSetWizardViewModel>& InViewModel);
