...
struct FMGAHeaderViewFunctionListItem : public FMGAHeaderViewListItem
{
	/** Creates a list item for the Header view representing a function declaration for the given blueprint function */
	static FMGAHeaderViewListItemPtr Create(const UK2Node_FunctionEntry* FunctionEntry);
...
protected:
	...
	explicit FMGAHeaderViewFunctionListItem(const UK2Node_FunctionEntry* FunctionEntry);
