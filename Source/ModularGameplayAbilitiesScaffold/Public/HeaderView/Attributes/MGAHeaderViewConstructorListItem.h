...
struct FMGAHeaderViewConstructorListItem : public FMGAHeaderViewListItem
{
	explicit FMGAHeaderViewConstructorListItem(const TSharedPtr<FMGAAttributeSetWizardViewModel>& InViewModel);
