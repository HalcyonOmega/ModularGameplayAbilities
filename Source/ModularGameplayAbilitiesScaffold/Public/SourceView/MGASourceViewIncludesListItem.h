...
struct FMGASourceViewIncludesListItem : public FMGAHeaderViewListItem
{
	explicit FMGASourceViewIncludesListItem(const TSharedPtr<FMGAAttributeSetWizardViewModel>& InViewModel);
