...
struct FMGASourceViewGetLifetimeListItem : public FMGAHeaderViewListItem
{
	explicit FMGASourceViewGetLifetimeListItem(const TSharedPtr<FMGAAttributeSetWizardViewModel>& InViewModel);
