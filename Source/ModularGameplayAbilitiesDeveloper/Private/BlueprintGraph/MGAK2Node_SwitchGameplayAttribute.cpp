...
UMGAK2Node_SwitchGameplayAttribute::UMGAK2Node_SwitchGameplayAttribute(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	FunctionName = TEXT("NotEqual_GameplayAttributeGameplayAttribute");
	FunctionClass = UModularAttributesHelpers::StaticClass();
	OrphanedPinSaveMode = ESaveOrphanPinMode::SaveNone;
}

void UMGAK2Node_SwitchGameplayAttribute::CreateFunctionPin()
{
...
void UMGAK2Node_SwitchGameplayAttribute::PostLoad()
{
	Super::PostLoad();
...
void UMGAK2Node_SwitchGameplayAttribute::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	bool bIsDirty = false;
	const FName PropertyName = PropertyChangedEvent.Property ? PropertyChangedEvent.Property->GetFName() : NAME_None;
	if (PropertyName == GET_MEMBER_NAME_CHECKED(UMGAK2Node_SwitchGameplayAttribute, PinAttributes) || PropertyName == FName("AttributeName"))
	{
		bIsDirty = true;
	}
...
FText UMGAK2Node_SwitchGameplayAttribute::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return NSLOCTEXT("K2Node", "ASBP_Switch_GameplayAttribute", "Switch on Gameplay Attribute");
}

FText UMGAK2Node_SwitchGameplayAttribute::GetTooltipText() const
{
...
void UMGAK2Node_SwitchGameplayAttribute::CreateSelectionPin()
{
...
FEdGraphPinType UMGAK2Node_SwitchGameplayAttribute::GetPinType() const
{
...
FEdGraphPinType UMGAK2Node_SwitchGameplayAttribute::GetInnerCaseType() const
{
	// This type should match the second argument of UMGABlueprintLibrary::NotEqual_GameplayAttributeGameplayAttribute !
	FEdGraphPinType PinType;
	PinType.PinCategory = UEdGraphSchema_K2::PC_String;
	return PinType;
}

FName UMGAK2Node_SwitchGameplayAttribute::GetPinNameGivenIndex(const int32 Index) const
{
	check(Index);
	return PinNames[Index];
}

void UMGAK2Node_SwitchGameplayAttribute::CreateCasePins()
{
...
FName UMGAK2Node_SwitchGameplayAttribute::GetUniquePinName()
{
	FName NewPinName;
	int32 Index = 0;
	while (true)
...
void UMGAK2Node_SwitchGameplayAttribute::AddPinToSwitchNode()
{
	const FName PinName = GetUniquePinName();
	PinNames.Add(PinName);
...
void UMGAK2Node_SwitchGameplayAttribute::RemovePin(UEdGraphPin* TargetPin)
{
	checkSlow(TargetPin);
